...
export const SUPPORTED_FIAT_CURRENCY_CODES = SUPPORTED_FIAT_CURRENCIES.map(
  (currency) => currency.code
);

export function isSupportedFiatCurrency(code: string): boolean {
  return SUPPORTED_FIAT_CURRENCY_CODES.includes(code.toUpperCase());
}
